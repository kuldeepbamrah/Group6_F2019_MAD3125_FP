...
public class SwipeToDeleteCallbackForEmployee extends ItemTouchHelper.SimpleCallback
{
    private Drawable icon;
    private final ColorDrawable background;

    private EmployeeDataAdapter mAdapter;
    public SwipeToDeleteCallbackForEmployee(EmployeeDataAdapter adapter)
    {
